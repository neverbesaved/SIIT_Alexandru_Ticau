...
function displayBMI(bmi) {
  ...
  if (bmi < 18.5 && bmi >= 0) {
    ...
    bmiConclusion.innerText =
      "Your bmi index is within the underweight range. Please eat more. ";
    ...
    var bmiConclusion = document.createElement("p");
    bmiConclusion.innerText =
      "You bmi index is withing the normal range. Good job.";
    ...
    var bmiConclusion = document.createElement("p");
    bmiConclusion.innerText =
      "Your bmi index is within the overweight range. Practice sport and exclude junk food.";
  } else if (bmi >= 30) {
    var bmiImage = document.createElement("img");
    ...
    var bmiConclusion = document.createElement("p");
    bmiConclusion.innerText =
      "Your bmi index is within the obese range. For your own health's sake - start doing physical activities and change alimentation routine ";
  } else {
    var bmiImage = document.createElement("img");
